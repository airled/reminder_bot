defmodule ReminderBot.Notificator do
  ...
  def send_initial_calendar_for_month(id, message_id) do
  ...
  def send_calendar_for_month(id, message_id, week_shift) do
    ...
    HTTPoison.post(@url_update, {:form, [chat_id: id, message_id: message_id, text: "Выберите день", reply_markup: markup]})
  end
  ...
  def send_hours_for_date(id, datetime, message_id) do
    ...
    HTTPoison.post(@url_update, {:form, [chat_id: id, message_id: message_id, text: "Выберите час", reply_markup: markup]})
  end
  ...
  def await_notification_text(datetime, id, message_id) do
    ...
    HTTPoison.post(@url_update, {:form, [chat_id: id, message_id: message_id, text: "Введите напоминание на #{day}.#{month}.#{year} #{hour}:00"]})
  end
